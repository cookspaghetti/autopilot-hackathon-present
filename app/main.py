...
# Slack cannot present a Command Center user session. This narrowly scoped public
# route authenticates every request with Slack's signing secret instead.
app.include_router(slack_insights_router, prefix=f"{BASE_PATH}/api")
